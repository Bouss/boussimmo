...
class SeLogerParserTest extends KernelTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->parser = new SeLogerParser($this->providerProvider->reveal(), new DecimalFormatter(), $this->logger->reveal());
    }
    ...
    public function testParseCreatesAPropertyFromAnEmail(): void
    {
        ...
        $html = u(file_get_contents($this->projectDir . '/tests/data/seloger.html','r'))->collapseWhitespace();
